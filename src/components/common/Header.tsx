                            ...
                            <Menubar className="bg-black text-white">
                                <MenubarMenu>
                                    <MenubarMenu>
                                        ...
                                        <MenubarContent>
                                            <MenubarSub>
                                                <MenubarItem><Link href={routs.categories}>Категории</Link>
                                                    <MenubarShortcut>🔎</MenubarShortcut></MenubarItem>
                                                <MenubarItem><Link href={routs.newCategory}>Добавить категорию</Link>
                                                    <MenubarShortcut>+</MenubarShortcut></MenubarItem>
                                                <MenubarItem><Link href={routs.product}>Мебель</Link>
                                                    <MenubarShortcut>🔎</MenubarShortcut></MenubarItem>
                                                <MenubarItem><Link href={routs.newProduct}>Добавить мебель</Link>
                                                    <MenubarShortcut>+</MenubarShortcut></MenubarItem>
                                            </MenubarSub>
                                        </MenubarContent>
                                        <MenubarMenu>

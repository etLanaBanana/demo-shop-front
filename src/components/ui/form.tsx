...
>(({ className, ...props }, ref) => {
  ...
  return (
    <p
      ...
      className={concatTailwindClasses("text-[0.8rem] text-muted-foreground", className)}
      {...props}
    />
  )
})
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <p
      ref={ref}
      id={formMessageId}
      className={concatTailwindClasses("text-[0.8rem] font-medium text-destructive", className)}
      {...props}
    >
      {body}
    </p>
